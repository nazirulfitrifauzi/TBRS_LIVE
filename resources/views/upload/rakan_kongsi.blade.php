<div class="col-span-6 sm:col-span-6">
    <label for="profile_pic" class="flex text-sm leading-5 font-medium text-gray-700">
        ** Sekiranya Rakan Kongsi/Pengarah lebih daripada 1 orang, sila muat naik dokumen berkenaan:
    </label>
    <div id="rk-div"
        ...
        style="display: block;">
        @if(isset(auth()->user()->perniagaan->partner_doc))
        <div class="flex" x-data="{ open: false }">
            <div class="justify-center">
                <span class="inline-flex rounded-md shadow-sm">
                    <a href="{{ asset('storage/'.auth()->user()->ic_no. '/' . auth()->user()->perniagaan->partner_doc) }}"
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm leading-5 text-gray-500">
                                    Adakah anda pasti untuk memadam fail Rakan Kongsi ini?
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                        <span class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
                            <button type="button"
                                ...
                                onclick="event.preventDefault();deleteRK({{auth()->user()->perniagaan->id}})">
                                Padam!
                            </button>
                        </span>
        ...
        <div class="text-center">
            <input type="file" name="doc_rk" id="rk" class="hidden" />
    ...
    <div id="rk-uploaded-div"
        ...
        <span id="rk-uploaded">Tiada fail diupload.</span>
    </div>
    {{-- end test --}}
</div>